...
#pragma GLOBAL_ASM("binary/BossTw_Init.o")

#pragma GLOBAL_ASM("binary/BossTw_Destroy.o")

#pragma GLOBAL_ASM("binary/BossTw_Update.o")

#pragma GLOBAL_ASM("binary/BossTw_Draw.o")
}
