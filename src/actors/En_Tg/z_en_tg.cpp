...
GLOBAL_ASM("binary/z_En_Tg.data.o")
...
GLOBAL_ASM("binary/EnTg_Init.o")

GLOBAL_ASM("binary/EnTg_Destroy.o")

GLOBAL_ASM("binary/EnTg_Update.o")

GLOBAL_ASM("binary/EnTg_Draw.o")
}
