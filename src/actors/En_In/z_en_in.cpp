...
GLOBAL_ASM("binary/z_En_In.data.o")
...
GLOBAL_ASM("binary/EnIn_Init.o")

GLOBAL_ASM("binary/EnIn_Destroy.o")

GLOBAL_ASM("binary/EnIn_Update.o")

GLOBAL_ASM("binary/EnIn_Draw.o")
}
