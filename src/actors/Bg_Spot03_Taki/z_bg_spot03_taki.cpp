...
GLOBAL_ASM("binary/BgSpot03Taki_Init.o")

GLOBAL_ASM("binary/BgSpot03Taki_Destroy.o")

GLOBAL_ASM("binary/BgSpot03Taki_Update.o")

GLOBAL_ASM("binary/BgSpot03Taki_Draw.o")
}
